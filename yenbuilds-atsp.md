...
Ask the LLMs to apply the ATSP protocol when you require it to be active. Cancel the protocol when you want more vibing. Upon protocol activation, ensure to apply it to the last code changes if you need it to, before going forwards with development.
